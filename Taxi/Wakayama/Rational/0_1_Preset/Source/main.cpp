...
MyData mySetParameter(bool isTestArea)
{
	MyData ret;
	{
		...
		ret.searchRange = 3001;
		ret.searchDegree = 180;
		ret.baseLengthMin = 200;
		ret.baseLengthMax = 1000;
		ret.demandCountCircleRadius = 201;
		ret.minDistancebetweenDemandCountCircle = 401;
		ret.vacantCountCircleRadius = 301;
	}
	return ret;
}
...
void mySaveParameter(const MyData &myData, const std::string &fileName, const std::string &fileDire)
{
	...
	// 保存
	{
		...
		// add child elements
		{
			...
			{
				boost::property_tree::ptree& child = root.put("demandCountCircleRadius", "");
				child.put("", myData.demandCountCircleRadius);
			}
			{
				boost::property_tree::ptree& child = root.put("minDistancebetweenDemandCountCircle", "");
				child.put("", myData.minDistancebetweenDemandCountCircle);
			}
			{
				boost::property_tree::ptree& child = root.put("vacantCountCircleRadius", "");
				child.put("", myData.vacantCountCircleRadius);
			}
		}
